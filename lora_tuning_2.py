# pip install torch transformers datasets peft huggingface_hub accelerate bitsandbytes sentencepiece tiktoken
import os
import json
import re
...
# ===== 3. 토크나이징 함수 =====
# 회의 전체 컨텍스트를 조금 더 살리려고 MAX_LEN 늘렷음
# MAX_LEN = 512      
# ANSWER_MAX = 256   
MAX_LEN = 1024
ANSWER_MAX = 384
...
dataset = load_dataset(
    "json",
    data_files={"train": ["output_agendas_converted.jsonl"]},
)
...
training_args = TrainingArguments(
    output_dir="./results_qwen3_8b_meeting",
    ...
    logging_dir="./logs_qwen3_8b_meeting",
    logging_steps=30,
...
# ===== 8. 모델 / 토크나이저 로컬 저장 =====
save_dir = "./Qwen3_8B_meeting_agenda_task"
...
api = HfApi()
repo_id = "CHOROROK/Qwen3_8B_meeting_agenda_task"
...
api.upload_folder(
    ...
    repo_id=repo_id,
    repo_type="model",
    commit_message="Upload Qwen3-8B meeting JSON (agenda & task) SFT LoRA adapter v1",
)
